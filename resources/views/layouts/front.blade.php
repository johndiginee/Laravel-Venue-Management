      ...
      <div class="container py-1">
        <div class="row align-items-center">
          <div class="col-8 col-md-8 col-lg-4">
            <h1 class=""><a href="/" class="h5 text-uppercase text-black"><strong>Venue Management<span class="text-danger">.</span></strong></a></h1>
          </div>
            ...
            <nav class="site-navigation text-right text-md-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    @foreach ($globalEventType as $eventType)
    ...
    <div class="container">
      ...
      <div class="row pt-5 mt-5 text-center">
        <div class="col-md-12">
          ...
          Copyright &copy; </script><script>document.write(new Date().getFullYear());</script> Venue Management App - All rights reserved | Web application was developed by HYFIG | Template by <a href="https://colorlib.com" target="_blank" >Colorlib</a>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
      </div>

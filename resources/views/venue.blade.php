      ...
      <div class="col-lg-8" style="margin-top: -150px;">
        <div class="mb-5">
          <div class="slide-one-item home-slider owl-carousel">
            <div><img src="{{ $venue->getFirstMediaUrl('main_photo', 'big_thumb')  }}" alt="{{ $venue->name }}" class="img-fluid"></div>
          </div>
        </div>
        <div class="bg-white">
          <div class="row mb-5">
          ...
          <div class="row mb-5">
            <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
              <span class="d-inline-block text-black mb-0 caption-text">Venue Types</span>
            ...
            <div class="col-12">
              ...
              <script>
                ...
                function initMap(){
                  ...
                  var marker = {"name": "{{ $venue->name }}", "latitude": {{ $venue->latitude }}, "longitude": {{ $venue->longitude }}  };
